...
const ResendActivate = ({verify,isAuthenticated,resend_verification}) => {
          ...
          <div className="p-8">
            ...
            <form className="space-y-6">
              <div className="space-y-1 w-full">
                <label className="input w-full input-bordered flex items-center rounded-md gap-2 bg-slate-200 dark:bg-slate-900 p-2 border-slate-300 dark:border-slate-600">
...
export default connect(mapStateToProps, {verify,resend_verification})(ResendActivate);